	...
	<DIV class=C_2>
		...
		<DIV class=C_8>
			<DIV class=C_13>
				...
				<s2:set name="hotAlbum" value="#request.hotAlbum" />
				<s2:iterator status="offset" value="hotAlbum">
								...
								<dl>
									<dd style="text-align: right; font-size: 12px; color: #666633;">
										...
										<s2:if test="#pageInfo.currentPage>0">
											<a href="gethotalbums.action" class="nor">首页</a>&nbsp;&nbsp;&nbsp;
									</s2:if>
										<s2:else>
										...
										<s2:if test="#pageInfo.currentPage>0">
											<a
												href="gethotalbums.action?currentPage=<s2:property value='#pageInfo.currentPage-1'/>"
												class="nor">上一页</a>&nbsp;
												</s2:if>
										<s2:else>
										...
										<s2:else>
											<a
												href="gethotalbums.action?currentPage=<s2:property value='#pageInfo.pageNum-1' />"
												class="nor">末页</a>
										</s2:else>
							</form>
						</div>
